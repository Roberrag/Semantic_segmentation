    ...
    def fit(self, epochs):
        ...
        for epoch in iterator:
            ...
            if self.model_save_best:
                best_acc = max([item for item in self.metrics['test_metric']])
                current_acc = output_test['metric']
                ...
                if current_acc >= best_acc:
                    ...
                    # torch.save(self.model.state_dict(), os.path.join(wandb.run.dir, "deeplabv3.pth"))
            else:
